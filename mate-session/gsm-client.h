...
struct _GsmClientClass {
  ...
  void (*end_session_response)(GsmClient *client, gboolean ok, gboolean do_last,
  ...
  gboolean (*impl_query_end_session)(GsmClient *client, guint flags,
                                     GError **error);
  gboolean (*impl_end_session)(GsmClient *client, guint flags, GError **error);
  gboolean (*impl_cancel_end_session)(GsmClient *client, GError **error);
  gboolean (*impl_stop)(GsmClient *client, GError **error);
  GKeyFile *(*impl_save)(GsmClient *client, GError **error);
};
...
gboolean gsm_client_end_session(GsmClient *client, guint flags, GError **error);
...
gboolean gsm_client_get_startup_id(GsmClient *client, char **startup_id,
                                   GError **error);
gboolean gsm_client_get_app_id(GsmClient *client, char **app_id,
                               GError **error);
